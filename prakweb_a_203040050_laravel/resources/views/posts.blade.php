...
<div class="container">
  ...
  @foreach ($posts->skip(1) as $post)
    ...
    <div class="card">
      <div class="position-absolute bg-dark px-3 py-2" style="background-color: rgba(0, 0, 0, 0.7)"><a href="/blog?category={{$post->category->slug }}"
       class="text-white text-decoration-none">{{ $post->category->name }}</div>
       @if($post->image)
  ...
  <div class="card-body">
    ...
    <a href="/posts/{{ $post->slug }}" class="btn btn-danger">Red More</a>
  </div>
</div>
    </div>
    @endforeach
